...
class AnalysisServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeText = channel.unary_unary(
                ...
                request_serializer=analysis__pb2.TextRequest.SerializeToString,
                response_deserializer=analysis__pb2.TextAnalysisResponse.FromString,
...
def add_AnalysisServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AnalyzeText': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=analysis__pb2.TextRequest.FromString,
                    response_serializer=analysis__pb2.TextAnalysisResponse.SerializeToString,
            ),
    }
...
class AnalysisService(object):
    ...
    def AnalyzeText(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analysis.AnalysisService/AnalyzeText',
            analysis__pb2.TextRequest.SerializeToString,
            analysis__pb2.TextAnalysisResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
